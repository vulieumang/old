 ...
 * $Id: configure.php 1853 2011-03-15 16:26:45Z emloog $
 */
...
if ($action == 'mod_config') {
	...
	if ($getData['login_code'] == 'y' && !function_exists("imagecreate") && !function_exists('imagepng')){
		formMsg("Bật mã xác nhận không thành công, hệ thống không hỗ trợ.","configure.php",0);
	}
	if ($getData['comment_code'] == 'y' && !function_exists("imagecreate") && !function_exists('imagepng')){
		formMsg("Bật mã nhận xét không thành công, hệ thống không hỗ trợ.","configure.php",0);
	}
