...
<div class="login-main">
	...
	<div class="checkbox"> <input type="checkbox" name="ispersis" id="ispersis" value="1" /><span>Ghi nhớ</span></div>
	<div class="button"><input type="submit" value="Đăng nhập" class="submit"></div>
	</div>
	<div style=" clear:both;"></div>
	<div class="login-bottom"></div>
	<div class="back"><a href="../">&laquo; Trang chủ</a></div>
</div>
</form>
