...
function klUploadFile($filename, $errorNum, $tmpfile, $filesize, $filetype, $type, $isIcon = 0){
	...
	$kl_album_compression_length = isset($navibar['kl_album']['compression_length']) ? intval($navibar['kl_album']['compression_length']) : 1024;
	$kl_album_compression_width = isset($navibar['kl_album']['compression_width']) ? intval($navibar['kl_album']['compression_width']) : 768;
...
function kl_album_addslashes($string){
