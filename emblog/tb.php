 ...
 * $Id: tb.php 1793 2010-10-22 00:07:45Z emloog $
 */
...
if (Option::get('istrackback') == 'y' && $logid && $title && $excerpt && $url && $blog_name){
	if($sc != substr(md5(gmdate('dnYG')), 0, 6)){
	...
	// Mot dia chi IP chi ton tai trong 5 gio
	$interval = 3600 * 5;
	$utctimestamp = time();
...
// Han che tieu de va ma hoa UTF-8
