...
setcookie('blab6_acpkey',$acp_key,time()+3600*$settings['acp_lhours'],'/');
redirect('admin.php');}
...
if(!isset($_COOKIE['blab6_acpkey']) || hsh($settings['acp_key'])!=$_COOKIE['blab6_acpkey']){
$title=$lang['acpkey'];
...
setcookie('blab6_acpkey','',time()+3600,'/');
redirect('admin.php');}
